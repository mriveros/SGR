...
$codusuario=  $_SESSION["codigo_usuario"];
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Producto ya existe. Ingrese otro Producto.");
                window.location="http://aplicaciones.intn.gov.py/SGR/web/productos/ABMproducto.php";
		</script>';
                }else{              
                //se define el Query   
		...
		alert("Error al inserta el Producto. Err(108):'.$query.'");
                ...
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/SGR/web/productos/ABMproducto.php");
                }
            }
        //si es Modificar    
