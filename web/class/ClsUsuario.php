 ...
 */
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Usuario ya existe. Intente ingresar otro Usuario");
                window.location="http://aplicaciones.intn.gov.py/SGR/web/usuarios/ABMusuario.php";
		</script>';
                }else{              
                //se define el Query   
                $query = "INSERT INTO usuarios(usu_nom,usu_ape,usu_username,usu_pass,usu_estado,cat_cod,usu_fecha)
                VALUES ('$nombreA','$apellidoA','$usernameA',md5('$passwordA'),'t',$categoriaA,now());";
                //ejecucion del query
		...
		alert("Error al inserta el usuario. Err(108):'.$query.'");
                ...
                $query = '';
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/SGR/web/usuarios/ABMusuario.php");
                }
            }
        //si es Modificar    
