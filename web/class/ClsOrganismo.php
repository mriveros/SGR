...
conexionlocal();
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Organismo ya existe. Ingrese otro Organismo.");
                window.location="http://aplicaciones.intn.gov.py/SGR/web/organismos/ABMorganismo.php";
		</script>';
                }else{              
                //se define el Query   
		...
		alert("Error al insertar el Organismo. Err(108):'.$query.'");
                window.location="http://aplicaciones.intn.gov.py/SGR/web/usuarios/ABMorganismo.php";
		</script>');
                $query = '';
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/SGR/web/organismos/ABMorganismo.php");
                }
            }
        //si es Modificar    
