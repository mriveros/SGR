 ...
 */
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("La dependencia ya existe. Intente ingresar otra Dependencia");
                window.location="http://aplicaciones.intn.gov.py/SGR/web/dependencia/ABMdependencia.php";
		</script>';
                }else{              
                //se define el Query   
		...
		alert("Error al insertar la dependencia. Err(108):'.$query.'");
                ...
                $query = '';
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/SGR/web/dependencia/ABMdependencia.php");
                }
            }
        //si es Modificar    
