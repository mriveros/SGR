 ...
 */
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("La marca ya existe. Intente ingresar otra marca");
                window.location="http://aplicaciones.intn.gov.py/SGR/web/marcas/ABMmarca.php";
		</script>';
                }else{              
                //se define el Query   
		...
		alert("Error al insertar la marca. Err(108):'.$query.'");
                ...
                $query = '';
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/SGR/web/marcas/ABMmarca.php");
                }
            }
        //si es Modificar    
