 ...
 */
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Encargado ya existe. Intente ingresar otro Encargado");
                ...
                //se define el Query   
                $query = "INSERT INTO encargado(en_nom,en_ape,en_estado,org_cod,depar_cod)
                VALUES ('$nombreA','$apellidoA','t',$organismoA,$departamentoA);";
                //ejecucion del query
        ...
        if(isset($_POST['modificar'])){
            $query = "update encargado set  en_nom='$nombreM',en_ape= '$apellidoM',en_estado='$activoM',org_cod=$organismoM,depar_cod=$departamentoM WHERE en_cod=$codigoModif";
            $ejecucion = pg_query($query) or die('<script type="text/javascript">
