 ...
 */
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Encargado ya existe. Intente ingresar otro Encargado");
                window.location="http://aplicaciones.intn.gov.py/SGR/web/encargados/ABMencargado.php";
		</script>';
                }else{              
                //se define el Query   
		...
		alert("Error al insertar el encargado. Err(108):'.$query.'");
                ...
                $query = '';
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/SGR/web/encargados/ABMencargado.php");
                }
            }
        //si es Modificar    
