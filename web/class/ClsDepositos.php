...
$codusuario=  $_SESSION["codigo_usuario"];
    ...
    if  (empty($_POST['txtCodigoE'])){$codigoElim=0;}else{$codigoElim=$_POST['txtCodigoE'];}
		...
		alert("El Deposito ya existe. Ingrese otro Deposito.");
                window.location="http://aplicaciones.intn.gov.py/SGR/web/dependencias/ABMdependencia.php";
		</script>';
                }else{              
                //se define el Query   
                ...
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/SGR/web/depositos/ABMdeposito.php");
                }
            }
        //si es Modificar    
