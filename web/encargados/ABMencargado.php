...
<head>
    ...
    <title>SGP INTN- Encargados</title>
    <!-- Bootstrap Core CSS -->
	...
	<script type="text/javascript">
		function modificar(codencargado){
			$('tr').click(function() {
			indi = $(this).index();
...
//                        alert(codencargado);
		...
		function eliminar(codencargado){
			document.getElementById("txtCodigoE").value = codencargado;
		};
	</script>
</head>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Encargados - <small>SGR INTN</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    $estado = 'Inactivo';
                      ...
                      ?>                          
                        ...
                        <a onclick='modificar(<?php echo $row1["en_cod"];?>)' class="btn btn-success btn-xs active" data-toggle="modal" data-target="#modalmod" role="button">Modificar</a>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="../class/ClsEncargado.php" method="post" role="form">
					    <div class="form-group">
                                ...
                                <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                            <input type="text" name="txtApellidoA" class="form-control" id="txtApellidoA" placeholder="ingrese apellido" required="true"/>
                                            </div>
					</div>	
                                
                                <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Organismo</label>
                                            <div class="col-sm-10">
                                                <select name="txtOrganismoA" class="form-control" id="txtOrganismoA" required="true">
                                                <?php
                                                //esto es para mostrar un select que trae datos de la BDD
                                                conexionlocal();
                                                $query = "Select org_cod,org_desc from organismo where org_estado='t' ";
	...
	<div class="modal fade" id="modalmod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form autocomplete="off" class="form-horizontal" name="modificarform" action="../class/ClsEncargado.php"  method="post" role="form">
                                        <div class="form-group">
                                <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Apellido</label>
                                            <div class="col-sm-10">
                                            <input type="text" name="txtApellidoM" class="form-control" id="txtApellidoM" placeholder="ingrese apellido" required="true"/>
                                            </div>
					</div>	
                                ...
                                <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Organismo</label>
                                            <div class="col-sm-10">
                                           <select name="txtOrganismoM" class="form-control" id="txtOrganismoM" required>
                                                <?php
                                                //esto es para mostrar un select que trae datos de la BDD
                                                conexionlocal();
                                                $query = "Select org_cod,org_desc from organismo where org_estado='t' ";
                                        ...
                                        <div class="form-group">
                                            <label  class="col-sm-2 control-label" for="input01">Departamento</label>
                                            <div class="col-sm-10">
                                           <select name="txtDepartamentoM" class="form-control" id="txtDepartamentoM" required>
                                                <?php
                                                //esto es para mostrar un select que trae datos de la BDD
                                                conexionlocal();
                                                $query = "Select depar_cod,depar_desc from departamentos_unidad where depar_estado='t' ";
	...
	<div class="modal fade" id="modalbor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form class="form-horizontal" name="borrarform" action="../class/ClsEncargado.php" onsubmit="return submitForm();" method="post" role="form">
						<div class="form-group">
