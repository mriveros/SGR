...
<html lang="es">
    ...
    <head>
        ...
        <title>SGR INTN- Migración</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Migración de Reactivos - <small>SGR INTN</small></h1>
                    </div>	
                </div>
                <!-- /.row -->
                <div class="row">
                                ...
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            and encargado.depar_cod=departamentos_unidad.depar_cod
                                            and encargado.en_cod=$codigo_encargado
                                            ...
                                            while ($row1 = pg_fetch_array($result)) {
                                                echo "<tr><td style='display:none'>".$row1["retidet_cod"]."</td>";
                                                   ...
                                                   echo "<td>".$row1["retidet_cantidad_actual"]."</td>";
                                                    echo "<td>";
                                                ?>
                                            <a  class="btn btn-info" onclick="migrarProducto(<?php echo $row1["retidet_cod"]; ?>)" data-toggle="modal" data-target="#modalagr" role="button">Migrar Reactivo</a>
                                                <?php
                                            echo "</td></tr>";
                                        }
