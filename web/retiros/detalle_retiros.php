                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row1 = pg_fetch_array($result)) {
                                                ...
                                                echo "<td>";
                                                ?>
                                            <a onclick='verDetalles(<?php echo $row1["reti_cod"]; ?>)' data-toggle="modal" data-target="#modaldetalles"  class="btn btn-primary btn-xs active" data-toggle="modal" data-target="#modalbor" role="button">Detalles</a>
                                            <?php
                                            echo "</td></tr>";
                                        }
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
                                    <form class="form-horizontal" name="borrarform" action="detalles_retiro.php" onsubmit="return submitForm();" method="post" role="form">
