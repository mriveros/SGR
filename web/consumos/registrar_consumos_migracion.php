...
<html lang="es">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Consumo de Reactivos Migración- <small>SGR INTN</small></h1>
                    </div>	
                </div>
                <!-- /.row -->
                <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                      ...
                                      usu_username,mig_cantidad_actual from producto,marca,departamentos_unidad,retiro_detalle,stock_detalle,migracion_producto,encargado,
                                      ...
                                      and departamentos_unidad.depar_cod=$codigo_departamento";
                                            ...
                                            while ($row1 = pg_fetch_array($result)) {
                                                echo "<tr><td style='display:none'>".$row1["mig_cod"]."</td>";
                                                   ...
                                                   echo "<td>".$row1["mig_cantidad_actual"]."</td>";
                                                    echo "<td>";
                                                ?>
                                            <a  class="btn btn-info" onclick="consumirProducto(<?php echo $row1["mig_cod"]; ?>)" data-toggle="modal" data-target="#modalagr" role="button">Consumir Reactivo</a>
                                                <?php
                                            echo "</td></tr>";
                                        }
	...
	<!-- /#MODAL AGREGACIONES -->
           <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <b><center>DATOS SOBRE CONSUMO MIGRACIÓN</b></center>
                            </div>
                            <div class="modal-body">
                                <form  autocomplete="off" class="form-horizontal" name="agregarform" action="../class/ClsConsumos_Migracion.php" method="post" role="form">
