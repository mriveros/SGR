...
<head>
    ...
    <title>SGP INTN- Presentación</title>
    <!-- Bootstrap Core CSS -->
	...
	<script type="text/javascript">
		function modificar(coddependencia){
			$('tr').click(function() {
			indi = $(this).index();
			var descripcion=document.getElementById("dataTables-example").rows[indi+1].cells[1].innerHTML;
//                        alert(codencargado);
                        document.getElementById("txtCodigo").value = coddependencia;
                        document.getElementById("txtDescripcionM").value = descripcion;
                       });
		};
		function eliminar(coddependencia){
			document.getElementById("txtCodigoE").value = coddependencia;
		};
	</script>
</head>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                      <h1 class="page-header">Presentación - <small>SGR INTN</small></h1>
                </div>	
            </div>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {
                        $estado = $row1["presen_estado"];
                         if ($estado == 't') {
                         $estado = 'Activo';
                       } else {
                    $estado = 'Inactivo';
                     }
                      echo "<tr><td style='display:none'>" . $row1["presen_cod"] . "</td>";                          
                      echo "<td>" . $row1["presen_desc"] . "</td>";
                      echo "<td>" . $estado . "</td>";
                      echo "<td>";
                      ?>                          
                       
                        <a onclick='modificar(<?php echo $row1["presen_cod"];?>)' class="btn btn-success btn-xs active" data-toggle="modal" data-target="#modalmod" role="button">Modificar</a>
                        <a onclick='eliminar(<?php echo $row1["presen_cod"];?>)' class="btn btn-danger btn-xs active" data-toggle="modal" data-target="#modalbor" role="button">Borrar</a>
                        <?php
                        echo "</td></tr>";
                    }
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="../class/ClsPresentacion.php" method="post" role="form">
	...
	<div class="modal fade" id="modalmod" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form autocomplete="off" class="form-horizontal" name="modificarform" action="../class/ClsPresentacion.php"  method="post" role="form">
                                        <div class="form-group">
                                <div class="col-sm-10">
	...
	<div class="modal fade" id="modalbor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form class="form-horizontal" name="borrarform" action="../class/ClsPresentacion.php" onsubmit="return submitForm();" method="post" role="form">
						<div class="form-group">
