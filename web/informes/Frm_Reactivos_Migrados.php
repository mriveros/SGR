...
<head>
    ...
    <title>SGR INTN- Informe Reactivos Migrados</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="row">
				...
				<div class="modal-header"><button type="button" class="close" data-dismiss="modal">
					<span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                        <h3 class="modal-title" id="myModalLabel"><i class="fa fa-archive"></i><center>PRODUCTOS MIGRADOS<br> Departamento - Unidad/Fecha</h3>
				</div>
            
				<!-- Modal Body -->
				<div class="modal-body">
                                    <form  autocomplete="off" class="form-horizontal" name="agregarform" action="Imp_Informe_Productos_Migrados.php" method="post" role="form">
